...
4. Если у вас имеются списки слов, которые вы уже знаете, перенесите их в словари (my_dictionary_en.xlsx – для английского, my_dictionary_es.xlsx – для испанского), которые находятся в корневой папке приложения. Для примера в словари уже внесены несколько слов. 
